...
#need to apply downsampling before the actual modeling
...
sdVec = apply(XtrainQuan, 2, sd, na.rm=TRUE)
which(sdVec < 0.0001)
...
nearZeroVar(XtrainQuan, saveMetrics = TRUE)
table(XtrainQuan$out_prncp)


#out_prncp is a good candidate to remove based on this metric so I am going to remove it.
XtrainQuan = XtrainQuan %>% select(-out_prncp)
